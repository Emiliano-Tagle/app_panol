...
class XDMedidasVarias extends StatelessWidget {
  XDMedidasVarias() : super();
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 90.0, start: 36.0),
            Pin(size: 74.0, middle: 0.2042),
            child:
