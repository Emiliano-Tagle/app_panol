...
class XDPedidosdetalles1 extends StatelessWidget {
  XDPedidosdetalles1() : super();
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 125.0, start: 27.0),
            Pin(size: 105.0, middle: 0.2022),
            child: Text.rich(
              TextSpan(
                style: TextStyle(
                  fontFamily: 'Segoe UI',
