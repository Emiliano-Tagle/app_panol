...
class XDInformacion extends StatelessWidget {
  XDInformacion() : super();
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 224.0, start: 44.0),
            Pin(size: 19.0, start: 161.0),
            child: Text(
              '1.0.0.1: Aplicación creada con éxito.',
              style: TextStyle(
                fontFamily: 'Roboto',
                fontSize: 14,
                color: const Color(0xff393939),
